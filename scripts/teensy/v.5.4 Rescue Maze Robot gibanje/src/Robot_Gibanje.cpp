...
void ROBOT_GIBANJE::Stay_Away_From_Left_Wall()
{
...
void ROBOT_GIBANJE::Stay_Away_From_Right_Wall()
{
        ...
        while ((Right_Front <= 12))
        {
                Go_Forward(15, 32 - Right_Front);
...
void ROBOT_GIBANJE::Keep_Optimal_Distance_With_Left_Wall(int Ideal_Left_Distance = 13)
{
        ...
        {
                Go_Forward(15, 20 + (Left_Front - Ideal_Left_Distance));
...
void ROBOT_GIBANJE::Keep_Optimal_Distance_With_Right_Wall(int Ideal_Right_Distance = 13)
{
        ...
        {
                Go_Forward(20 + (Right_Front - Ideal_Right_Distance), 15);
...
int ROBOT_GIBANJE::Optimize_speed_with_Z_Orientation(int Z_Orientatio_Tolerance = 13)
{
        int left_and_right_motor_speed;
        int Z_Orientation = Read_Gyroscope_Z_Axis_Orientation();

        Z_Orientation = Read_Gyroscope_Z_Axis_Orientation();
        if (Z_Orientation > Z_Orientatio_Tolerance)
        {
                left_and_right_motor_speed = 20 + (Z_Orientation - Z_Orientatio_Tolerance);
        }
        else
        {
...
void ROBOT_GIBANJE::Stay_Away_From_Left_Wall_Optimized_For_Autonomus_Loop(int Left_Front_Distance, int Forward_Left_distance, int Forward_Right_distance, boolean founded_black_or_gray_tiles, int left_and_right_motor_speed, int Go_Forward_Delay = 100)
{
...
void ROBOT_GIBANJE::Stay_Away_From_Right_Wall_Optimized_For_Autonomus_Loop(int Right_Front_Distance, int Forward_Left_distance, int Forward_Right_distance, boolean founded_black_or_gray_tiles, int left_and_right_motor_speed, int Go_Forward_Delay = 100)
{
...
void ROBOT_GIBANJE::Keep_Optimal_Distance_With_Left_Wall_Optimized_For_Autonomus_Loop(int Left_Front_Distance, int Forward_Left_distance, int Forward_Right_distance, boolean founded_black_or_gray_tiles, int left_and_right_motor_speed, int Go_Forward_Delay = 100, int Ideal_Left_Distance = 13)
{
        while ((Left_Front_Distance >= 14) && (Left_Front_Distance <= 25) && (Forward_Left_distance > Optimal_Stop_Front_Distance_For_Center_Robot) && (Forward_Right_distance > Optimal_Stop_Front_Distance_For_Center_Robot) && (founded_black_or_gray_tiles == false))
        {
                Serial.println(" ");
                Serial.println("Keep optimal distance with LEFT wall. #########################################################");
                Serial.println(" ");
                ...
                Go_Forward(15, 20 + (Left_Front_Distance - Ideal_Left_Distance));
                delay(Go_Forward_Delay);
...
void ROBOT_GIBANJE::Keep_Optimal_Distance_With_Right_Wall_Optimized_For_Autonomus_Loop(int Right_Front_Distance, int Forward_Left_distance, int Forward_Right_distance, boolean founded_black_or_gray_tiles, int left_and_right_motor_speed, int Go_Forward_Delay = 100, int Ideal_Right_Distance = 13)
{
        while ((Right_Front_Distance >= 14) && (Right_Front_Distance <= 25) && (Forward_Left_distance > Optimal_Stop_Front_Distance_For_Center_Robot) && (Forward_Right_distance > Optimal_Stop_Front_Distance_For_Center_Robot) && (founded_black_or_gray_tiles == false))
        {
                Serial.println(" ");
                Serial.println("Keep optimal distance with RIGHT wall. #########################################################");
                Serial.println(" ");
                ...
                Go_Forward(20 + (Right_Front_Distance - Ideal_Right_Distance), 15);
                delay(Go_Forward_Delay);
...
int ROBOT_GIBANJE::Optimize_speed_with_Z_Orientation_Optimized_For_Autonomus_Loop(int left_and_right_motor_speed = 20, int Z_Orientation_Tolerance = 13)
{
        int Z_Orientation = Read_Gyroscope_Z_Axis_Orientation();

        if (Z_Orientation > Z_Orientation_Tolerance)
        {
                left_and_right_motor_speed = 20 + (Z_Orientation - Z_Orientation_Tolerance);
        }
