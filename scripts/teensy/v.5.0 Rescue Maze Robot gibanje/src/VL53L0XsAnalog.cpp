 ...
 */
void VL53L0XsAnalog::add(uint8_t pin) {
        if (nextFree >= MAX_VL53L0XS_ANALOG)
 ...
 */
void VL53L0XsAnalog::print(String message, bool eol) {
        if (eol) {
 ...
 */
void VL53L0XsAnalog::test(BreakCondition breakWhen) {
        char buffer[30];
 ...
 */
VL53L0XsAnalog::VL53L0XsAnalog(HardwareSerial * hardwareSerial) {
        serial = hardwareSerial;
        nextFree = 0;
}

VL53L0XsAnalog::~VL53L0XsAnalog(){
}
