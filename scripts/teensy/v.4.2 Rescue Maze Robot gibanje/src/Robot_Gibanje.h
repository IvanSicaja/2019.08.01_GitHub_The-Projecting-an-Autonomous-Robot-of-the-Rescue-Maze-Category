...
#define SPEED_FRONT_LEFT_MOTOR_PIN      2    // 1. motor, pin for motor speed
#define DIRECTION_FRONT_LEFT_MOTOR_PIN  3    // 1. motor, pin for motor direction
#define SPEED_FRONT_RIGHT_MOTOR_PIN     4    // 2. motor, pin for motor speed
#define DIRECTION_FRONT_RIGHT_MOTOR_PIN 5    // 2. motor, pin for motor direction
#define SPEED_BACK_LEFT_MOTOR_PIN      6    // 3. motor, pin for motor speed
#define DIRECTION_BACK_LEFT_MOTOR_PIN  7    // 3. motor, pin for motor direction
#define SPEED_BACK_RIGHT_MOTOR_PIN     8    // 4. motor, pin for motor speed
#define DIRECTION_BACK_RIGHT_MOTOR_PIN 9    // 4. motor, pin for motor direction
