...
//############################################################## Autonomus functions ###################################################################################################################################################
    ...
    void Go_Autonomus_Adventage_Version_Optimized(int Orientation_Tolerance = 1, boolean Avoid_Side_Walls_P_Regulator_Turned_On = true , boolean Keep_Optimal_Distance_With_Side_Walls_P_Regulator_Turned_On = true, boolean Optimize_Speed_With_Z_Axis_Value_P_Regulatro_Turned_On = true, int delayTime = 0);
