...
void ROBOT_GIBANJE::Rotate_Right_With_Specific_Angle(int angle, int delayTime=0, int motor_speed = 30)  //angle ust be  values between 0 and 90 degrees
{
       ...
       delay(delayTime);
        ...
        if ((initial_heading >= 271) && (initial_heading <= 360))
        {
                initial_heading = Read_Heading() - 360;
                wanted_heading = initial_heading + angle;
               ...
               delay(delayTime);
                ...
                while ((initial_heading >= -89) && (initial_heading < 0) && (initial_heading < wanted_heading))
                {
                ...
                while (initial_heading < wanted_heading)
                {
...
void ROBOT_GIBANJE::Rotate_Left_With_Specific_Angle(int angle, int delayTime=0, int motor_speed = 30)  //angle ust be  values between 0 and 90 degrees
{
        ...
        if ((initial_heading >= 0) && (initial_heading <= 89))
        {
                initial_heading = Read_Heading() + 360;
                wanted_heading = initial_heading - angle;
                ...
                while ((initial_heading >= 360) && (initial_heading < 449)&& (initial_heading > wanted_heading))
                {
...
int ROBOT_GIBANJE::Align_To_Left_Wall(int delayTime=0)
{
      ...
      if (((WallFollowingError * WallFollowingError) > 1))
      {
...
void ROBOT_GIBANJE:: Follow_Gyrosope_With_PID_Controller(){

      int Current_Orientation;
      int Orientation_Tolerance=1;
      Setpoint1 = Align_To_Left_Wall();
      ...
      while ((Read_Forward_Left_Distance() > Front_Stop_Distance()) || (Read_Forward_Right_Distance() > Front_Stop_Distance()))
      {
