...
public:
    ...
    int Optimize_speed_with_Z_Orientation(int Z_Orientation_Tolerance_First_Degree = 8, int Z_Orientation_Tolerance_Second_Degree = 15);
    ...
    void Keep_Optimal_Distance_With_Left_Wall_Optimized_For_Autonomus_Loop( int Left_Front_Distance, int Forward_Left_distance, int Forward_Right_distance, boolean founded_black_or_gray_tiles, int left_and_right_motor_speed, int Go_Forward_Delay=100, int Ideal_Left_Distance = 13, int wanted_running_function_time = 600);   // Works fine - need P regulator paremetters calibration
    void Keep_Optimal_Distance_With_Right_Wall_Optimized_For_Autonomus_Loop(int Right_Front_Distance, int Forward_Left_distance, int Forward_Right_distance, boolean founded_black_or_gray_tiles, int left_and_right_motor_speed, int Go_Forward_Delay=100,int Ideal_Right_Distance = 13, int wanted_running_function_time = 600);  // Works fine - need P regulator paremetters calibration
    int Optimize_speed_with_Z_Orientation_Optimized_For_Autonomus_Loop(int left_and_right_motor_speed,int Z_Orientation_Tolerance_First_Degree = 8, int Z_Orientation_Tolerance_Second_Degree = 15);
