...
const float Check_Walls_Distance = 200; //Variable for checking is walls opend
...
void ROBOT_GIBANJE::Go_Forward_PID_Corrected(int Current_Orientation,int Orientation_Tolerance = 1, int delayTime = 0)
{
        ...
        while ((Read_Forward_Left_Distance() > 100) && (Read_Forward_Right_Distance() > 100)) //condition - probably encoder distance
        {
...
void ROBOT_GIBANJE::Read_Right_Encoder(int right_motor_speed = 20)
{
        SetMotorSpeedAndDirection(SPEED_BACK_RIGHT_MOTOR_PIN, DIRECTION_BACK_RIGHT_MOTOR_PIN, right_motor_speed);
...
void ROBOT_GIBANJE::Read_Left_Encoder(int left_motor_speed = 20)
{
...
void ROBOT_GIBANJE::Go_Autonomus_with_PID(int Orientation_Tolerance = 1, int delayTime = 0)
{
        ...
        while ((Forward_Left_distance > 300) && (Forward_Right_distance > 300)) //condition - probably encoder distance
        {
