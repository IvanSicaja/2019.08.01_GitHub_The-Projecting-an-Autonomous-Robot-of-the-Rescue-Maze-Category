...
void ROBOT_GIBANJE::SetupZaSveKomponente()
{
        ...
        pinMode(LEFT_THERMAL_CAM_OUT_PIN, INPUT); // Analog input pin A9, connected to thermal sensor OUT output
...
void ROBOT_GIBANJE::Go_Autonomus_with_PID(int Orientation_Tolerance = 1, int delayTime = 0)
{
        ...
        while ((Forward_Left_distance > 300) && (Forward_Right_distance > 300) && (founded_black_or_gray_tiles == false)) //condition - probably encoder distance
        {
                if (Serial.available() > 0)
                {
                ...
                */
                ...
                while ((Left_Front_Distance < 240) && (Forward_Left_distance > 300) && (Forward_Right_distance > 300) && (founded_black_or_gray_tiles == false))
                {
                        //Serial.println(" ");
                        //Serial.println("GO RIGHT - Too closed to Leftt wall. #########################################################");
                        //Serial.println(" ");
                ...
                while ((Right_Front_Distance < 200) && (Forward_Left_distance > 300) && (Forward_Right_distance > 300) && (founded_black_or_gray_tiles == false))
                {
                        //Serial.println(" ");
