...
int redMin = 3100;    // Red minimum value
int redMax = 38915;   // Red maximum value
int greenMin = 1200;  // Green minimum value
int greenMax = 12436; // Green maximum value
int blueMin = 1441;   // Blue minimum value
int blueMax = 17000;  // Blue maximum value
...
{ // Default speed is maximum when you don't send any value to function
        ...
        SetMotorSpeedAndDirection(SPEED_LEFT_MOTOR_PIN, DIRECTION_LEFT_MOTOR_PIN, left_motor_speed);
        SetMotorSpeedAndDirection(SPEED_RIGHT_MOTOR_PIN, DIRECTION_RIGHT_MOTOR_PIN, right_motor_speed);
...
void ROBOT_GIBANJE::Search_for_Black_or_Grey_tiles()
{
        ...
        */
        ...
        if ((redValue < 1061) && (greenValue < 975) && (blueValue < 1002))
        {
...
void ROBOT_GIBANJE::Go_Forward_PID_Corrected(int Orientation_Tolerance = 1, int delayTime = 0)
{
        int Current_Orientation;
