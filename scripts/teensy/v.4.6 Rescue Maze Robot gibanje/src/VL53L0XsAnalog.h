...
#include <Arduino.h>
/**
   Purpose: Reading of STM VL53L0X lidars, analog output(s).
   @author MRMS team
   @version 0.0 2018-12-31
   Licence: You can use this code any way you like.
 */

#define MAX_VL53L0XS_ANALOG 10 //Maximum number of sensors.
...
class VL53L0XsAnalog
{
int nextFree;
uint8_t pins[MAX_VL53L0XS_ANALOG];
 ...
 */
VL53L0XsAnalog(HardwareSerial * hardwareSerial = 0);
