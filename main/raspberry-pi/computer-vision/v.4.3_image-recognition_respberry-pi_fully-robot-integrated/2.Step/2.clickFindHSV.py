...
#Function for converting RGB values to HSV values
def rgb2hsv(r, g, b):
    ...
    print("HSV_S ",round(hScaled,1)," ",round(sScaled,1)," ",round(vScaled,1))
...
print("Enter 'r' for red image, 'y' for yellow image or 'g' for green image. ")
char=input()
...
if (char=="r"):
    ...
    pic="/home/pi/Desktop/v.4.2_ImageRecognition/1.Step/Color_victims_images_for_calibration/Red_victim.png"                #Include image (reletive adressing)
...
if (char=="y"):
    ...
    pic="/home/pi/Desktop/v.4.2_ImageRecognition/1.Step/Color_victims_images_for_calibration/Yellow_victim.png"                #Include image (reletive adressing)
    pic1=p.Image.open(pic)              #Open image
    width, height=pic1.size             #Opend image dimension
    imgSize=str(width)+"x"+str(height)
    print("Dimensions of image are: ")
...
if (char=="g"):
    ...
    pic="/home/pi/Desktop/v.4.2_ImageRecognition/1.Step/Color_victims_images_for_calibration/Green_victim.png"                #Include image (reletive adressing)
    pic1=p.Image.open(pic)              #Open image
    width, height=pic1.size             #Opend image dimension
    imgSize=str(width)+"x"+str(height)
    print("Dimensions of image are: ")
